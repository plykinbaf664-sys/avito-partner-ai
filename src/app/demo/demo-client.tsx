...
const enumLabels: Record<string, string> = {
  ...
  POTENTIAL_UNITS: "Потенциальное число объектов",
  GOAL: "Цель человека",
  EXPERIENCE: "Опыт",
  BARRIER: "Основное сомнение / барьер",
  INSUFFICIENT_BUDGET: "Недостаточный бюджет для запуска",
  NO_LAUNCH_INTENT: "Нет намерения запускаться",
  NO_OPERATIONAL_READINESS: "Нет готовности участвовать",
  UNSUPPORTED_REGION: "Регион не поддерживается",
  ...
  BORDERLINE_BUDGET: "Пограничный бюджет",
  WEAK_LAUNCH_INTENT: "Слабая готовность к запуску",
  LIMITED_OPERATIONAL_CAPACITY: "Ограниченная возможность участвовать",
  BUDGET_UNKNOWN: "Бюджет не выяснен",
  BUDGET_NOT_CONFIRMED: "Бюджет требует подтверждения",
  ...
  BASE_REQUIREMENTS_MET: "Базовые условия выполнены",
  HOT_READINESS_CONFIRMED: "Подтверждена готовность к запуску",
  PRIORITY_SCALE_CONFIRMED: "Подтверждён потенциал пяти и более объектов",
...
const nextStepLabels: Record<string, string> = {
  ...
  BUDGET: "Следующий шаг: уточнить доступный бюджет на запуск.",
  ...
  POTENTIAL_UNITS:
    "Следующий шаг: выяснить, со скольких объектов человек хочет начать и до какого количества готов масштабироваться.",
  GOAL:
